...
export default function AdminCategoriasPage() {
  ...
  return (
    <div className="max-w-xl">
      ...
      <form onSubmit={handleCreate} className="bg-white border border-gray-200 rounded p-5 mb-6 flex items-end gap-3">
        ...
        <button
          type="submit"
          disabled={saving}
          className="bg-[#0070F3] text-white text-sm px-4 py-2 rounded disabled:opacity-60"
        >
